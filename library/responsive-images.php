...
add_image_size( 'featured-small', 640, 360, true ); // name, width, height, crop
add_image_size( 'featured-medium', 1280, 720, true );
add_image_size( 'featured-large', 1536, 864, true );
